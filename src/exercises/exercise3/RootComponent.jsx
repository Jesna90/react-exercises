...
const RootComponent = () => {
	...
	return(
		<div>
			<p>Here we define that the change can be returned with coins of 5, 2 and 1
				<br/>The returned change calculates the best amount to return the least amount of coins
				<br/>The easiest way to do that is (IMO) with arrays and so the way the return is calculated can be extended to use other values..
				<br/>For example it should be possible just to switch it to use 1,2,5,10,20,50 to return "bank notes/bigger cuts" too
				<br/>
			</p>
			<ButtonToggle />
